  ...
  return (
    <div style={{ maxWidth: 560, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 22 }}>
        ...
        <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 22, fontWeight: 700, color: COLORS.textPri, marginTop: 8 }}>Join OpenExport</div>
    ...
    <div style={{ background: COLORS.bg, minHeight: "100vh", color: COLORS.textPri, fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ borderBottom: `1px solid ${COLORS.border}`, background: COLORS.s1, padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 60, position: "relative", zIndex: 25 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          {!liveUser ? (
            <>
              <button onClick={() => setView("login")} style={{ ...secondaryBtn, fontSize: 11.5 }}>Sign In</button>
              <button onClick={() => setView("signup")} style={{ ...primaryBtn, fontSize: 11.5, padding: "8px 14px" }}>Create Account</button>
            </>
          ) : (
            <>
